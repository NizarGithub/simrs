...
var Pagination = function (el, options) {
	...
	var $container = $(el),
		...
		firstPageLabel = options.labels.first || '<i class="fa fa-step-backward"></i>',
		lastPageLabel = options.labels.last || '<i class="fa fa-step-forward"></i>',
		nextPageLabel = options.labels.next || '<i class="fa fa-chevron-right"></i>',
		previousPageLabel = options.labels.previous || '<i class="fa fa-chevron-left"></i>',
	...
	getRenderedPager = function () {
		return '<ul class="pags">' + getRenderedPageNumbers() + '</ul>';
	};
	...
	getRenderedPageNumbers = function () {
		...
		result = '<li data-page="' + PREVIOUS_PAGE_NUMBER + '"><a href="javascript:void(0)"><span aria-hidden="true">' + previousPageLabel + '</span></a></li>';
