...
class Transaksi_penjualan_m extends CI_Model
{
    ...
    function get_penjualan($keyword, $id_klien){
        ...
        $sql = "
        SELECT * FROM ak_penjualan WHERE ID_KLIEN = $id_klien
        ORDER BY ID ASC
        ";
    ...
    function get_data_trx_detail($id){
        $sql = "
        SELECT * FROM ak_penjualan_detail WHERE ID_PENJUALAN = $id
        ";
    ...
    function get_penjualan_filter($keyword, $id_klien, $tgl_awal, $tgl_akhir){
        ...
        $sql = "
        SELECT * FROM ak_penjualan WHERE ID_KLIEN = $id_klien AND $where
        ORDER BY ID ASC
        ";
    ...
    function simpan_penjualan($id_klien, $no_trx, $id_pelanggan, $pelanggan, $alamat_tagih, $tgl_trx, $tgl_jatuh_tempo, $id_pajak, $sub_total, $pajak_total, 
                              $total_all, $sts_lunas, $memo_lunas, $akun_piutang, $kode_akun_pajak)
    {
        ...
        (ID_KLIEN, NO_BUKTI, ID_PELANGGAN, PELANGGAN, ALAMAT, TGL_TRX, TGL_JATUH_TEMPO, ID_PAJAK, SUB_TOTAL, NILAI_PAJAK, TOTAL, LUNAS, MEMO, KODE_AKUN_PIUTANG, KODE_AKUN_PAJAK)
        VALUES 
        ($id_klien, '$no_trx', $id_pelanggan, '$pelanggan', '$alamat_tagih', '$tgl_trx', '$tgl_jatuh_tempo', $id_pajak, $sub_total, $pajak_total, $total_all, $sts_lunas, '$memo_lunas', '$akun_piutang', '$kode_akun_pajak')
        ";
    ...
    function simpan_detail_penjualan($id_penjualan, $id_klien, $nama_produk, $qty, $satuan, $harga_satuan, $jumlah){
