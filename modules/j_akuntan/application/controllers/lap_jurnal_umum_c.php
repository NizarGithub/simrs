...
class Lap_jurnal_umum_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_jurnal_umum_m','model');
	...
	function cetak_jurnal_umum_pdf(){
		...
		$view = "pdf/report_jurnal_umum_pdf";
		$dt = "";
		$judul = "";
		...
		if($filter == "Harian"){
			...
			$dt = $this->model->get_lap_jurnal_umum_bulanan($id_klien, $bulan, $tahun);
		} 
	...
	function cetak_jurnal_umum_xls(){
		...
		$filter = $this->input->post('filter');
		$view = "xls/report_jurnal_umum_xls";
		$dt = "";
		$judul = "";
