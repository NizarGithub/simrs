				...
				<table class="stat-table table table-hover">
					...
					<tbody id="tes">
						...
						<tr>
							...
							<td align="center"> 								
								<button onclick="ubah_data_produk(<?=$row->ID;?>);" type="button" class="btn btn-small btn-warning"> <i class="icon-edit"></i> Ubah Kategori </button>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					...
					<div class="form-actions">
						<input type="submit" class="btn btn-success" name="edit" value="Ubah Data Kategori">
