...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Buat Penjualan Baru </h3>
		</div>
		<ul class="breadcrumb">
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	...
	<div class="span3">
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input readonly type="text" class="span12" value="INV-<?=$no_transaksi;?>" name="no_trx" id="no_trx">
						...
						<tr id="tr_1" class="tr_utama">
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" id="nama_produk_1" name="nama_produk[]" readonly style="background:#FFF;">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									...
									<input type="hidden" id="qty_max_1" name="qty_max[]" value="">
								</div>
							</td>
