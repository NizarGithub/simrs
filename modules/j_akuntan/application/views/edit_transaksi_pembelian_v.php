	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-append">
				<input type="text" id="pelanggan" name="pelanggan" value="<?=$dt->PELANGGAN;?>" readonly style="background:#FFF;">
						...
						<tr id="tr_<?=$det->ID;?>" class="tr_utama">
							<td align="center" style="vertical-align:middle;"> 	
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" id="nama_produk_<?=$det->ID;?>" name="nama_produk[]" required style="background:#FFF;" value="<?=$det->NAMA_PRODUK;?>">
