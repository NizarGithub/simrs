    ...
    <?php
        ...
        foreach ($data as $key => $row) {
            ...
            if ($old_koper != $koper) {
                ...
                echo "<tr>" ;
                echo "<td style='vertical-align:middle; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border' colspan='4'> NO BUKTI : <b style='color:#2980B9;'>".$row->NO_VOUCHER."</b> <b> | ".$row->TGL."</b> </td>" ;
                echo "</tr>" ;

                echo "<tr>" ;
                echo "<td style='vertical-align:middle; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border' colspan='4'> URAIAN : <b> ".$row->URAIAN."  ".$no_jp." </b> </td>" ;
                echo "</tr>" ;
