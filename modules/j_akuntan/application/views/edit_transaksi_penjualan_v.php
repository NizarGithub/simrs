...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-pencil"></i>  Ubah Transaksi Penjualan </h3>
	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-append">
				<input type="text" id="pelanggan" name="pelanggan" readonly style="background:#FFF;" value="<?=$dt->PELANGGAN;?>">
				<input type="hidden" id="pelanggan_sel" name="pelanggan_sel" value="<?=$dt->ID_PELANGGAN;?>" style="background:#FFF;">
	...
	<div class="span4">
		<div class="control-group" style="margin-left: 20px;">
			<label class="control-label"> <b style="font-size: 14px;"> Alamat Penagihan </b> </label>
				<div class="controls">
					<textarea rows="4" id="alamat_tagih" name="alamat_tagih" style="resize:none; height: 87px; width: 324px;"><?=$dt->ALAMAT;?></textarea>
				</div>
		</div>
	</div>
			...
			<label class="control-label"> <b style="font-size: 14px;"> Tanggal Transaksi </b> </label>
				<div class="controls">
					<div id="datetimepicker1" class="input-append date ">
						<input value="<?=$dt->TGL_TRX;?>" required name="tgl_trx" onclick="$('#add_on_pick').click();" data-format="dd-MM-yyyy" type="text"><span class="add-on "><i id="add_on_pick" data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span>
					</div>
				</div>
		</div>
	...
	<div class="span4">
		<div class="control-group">
			<label class="control-label"> <b style="font-size: 14px;"> Uraian </b> </label>
				<div class="controls">
					<textarea rows="4" id="memo_lunas" name="memo_lunas" style="resize:none; height: 87px; width: 324px;"><?=$dt->MEMO;?></textarea>
				</div>
		</div> 
	</div>
</div>
						...
						<tr id="tr_<?=$det->ID;?>" class="tr_utama">
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" id="nama_produk_<?=$det->ID;?>" name="nama_produk[]" value="<?=$det->NAMA_PRODUK;?>" style="background:#FFF;">
											<input type="hidden" id="id_produk_<?=$det->ID;?>" name="produk[]" style="background:#FFF;">
											<button onclick="show_pop_produk(<?=$det->ID;?>);" type="button" class="btn">Cari</button>
										</div>
									</div>
								</div>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="always_one(<?=$det->ID;?>);" onchange="always_one(<?=$det->ID;?>); hitung_total(<?=$det->ID;?>);" id="qty_<?=$det->ID;?>" style="font-size: 18px; text-align:center; width: 80px;" type="number"  value="<?=$det->QTY;?>" name="qty[]">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input style="font-size: 18px; text-align:left; width: 90px;" type="text"  value="<?=$det->SATUAN;?>" name="satuan[]" id="satuan_<?=$det->ID;?>">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input required onkeyup="FormatCurrency(this); hitung_total(<?=$det->ID;?>);" style="font-size: 18px; text-align:right; width: 175px;" type="text"  value="<?=number_format($det->HARGA_SATUAN);?>" name="harga_satuan[]" id="harga_satuan_<?=$det->ID;?>">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input readonly onkeyup="FormatCurrency(this);" style="font-size: 18px; text-align:right; width: 175px; background:#FFF;" type="text"  value="<?=number_format($det->TOTAL);?>" name="jumlah[]" id="jumlah_<?=$det->ID;?>">
								</div>
							</td>
							...
							<td class="center" style="background:#FFF; text-align:center;">
								<button onclick="hapus_row(<?=$det->ID;?>);" type="button" class="btn btn-danger"> Hapus </button>
							</td>
							<?PHP } ?>
						</tr>
						<?PHP } ?>
					...
					<div class="span3">
						<div class="control-group">
							<label class="control-label"> <b style="font-size: 14px;"> Pajak </b> </label>
								<div class="controls">
									<select required data-placeholder="Pilih Pajak ..." class="chzn-select" tabindex="2" style="width:150px;" name="id_pajak" id="id_pajak_sel" onchange="hitung_pajak(this.value);">
