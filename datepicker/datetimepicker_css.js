...
var imageFilesPath = url+"datepicker/images2/";
...
function RenderCssCal(bNewCal)
{
	...
	{
	    vCalHeader += "<td align='center'><select style='height:35px;width: 100px;' name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select style='height:35px;width: 70px;' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
