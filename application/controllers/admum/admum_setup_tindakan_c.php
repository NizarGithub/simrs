...
class Admum_setup_tindakan_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_tindakan_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_tindakan_v',
			'title' => 'Setup Tindakan',
			'subtitle' => 'Setup Tindakan',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'tindakan',
			'url_simpan' => base_url().'admum/admum_setup_tindakan_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_tindakan_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_tindakan_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_tindakan_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_tindakan_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_tindakan_c');
	}
