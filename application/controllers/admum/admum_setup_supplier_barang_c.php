...
class Admum_setup_supplier_barang_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_supplier_barang_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_supplier_barang_v',
			'title' => 'Supplier Barang',
			'subtitle' => 'Supplier Barang',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'supplier_barang',
			'url_simpan' => base_url().'admum/admum_setup_supplier_barang_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_supplier_barang_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_supplier_barang_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_supplier_barang_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_data_supplier_barang_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_supplier_barang_c');
	}
