...
class Admum_setup_visite_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_visite_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_visite_v',
			'title' => 'Setup Visite',
			'subtitle' => 'Setup Visite',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'visite',
			'url_simpan' => base_url().'admum/admum_setup_visite_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_visite_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_visite_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_visite_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_data_visite_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_visite_c');
	}
