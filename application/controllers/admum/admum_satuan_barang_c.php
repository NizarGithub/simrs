...
class Admum_satuan_barang_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_satuan_barang_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_satuan_barang_v',
			'title' => 'Setup Satuan Barang',
			'subtitle' => 'Setup Satuan Barang',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'satuan_barang',
			'url_simpan' => base_url().'admum/admum_satuan_barang_c/simpan',
			'url_ubah' => base_url().'admum/admum_satuan_barang_c/ubah',
			'url_hapus' => base_url().'admum/admum_satuan_barang_c/hapus',
			'url_cetak' => base_url().'admum/admum_satuan_barang_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_satuan_barang_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_satuan_barang_c');
	}
