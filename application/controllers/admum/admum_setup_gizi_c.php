...
class Admum_setup_gizi_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_gizi_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_gizi_v',
			'title' => 'Setup Gizi',
			'subtitle' => 'Setup Gizi',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'gizi',
			'url_simpan' => base_url().'admum/admum_setup_gizi_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_gizi_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_gizi_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_gizi_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_data_gizi_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_gizi_c');
	}
