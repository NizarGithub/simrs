...
class Admum_setup_pemeriksaan_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_pemeriksaan_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_pemeriksaan_v',
			'title' => 'Setup Pemeriksaan Laborat',
			'subtitle' => 'Setup Pemeriksaan Laborat',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'pemeriksaan',
			'url_simpan' => base_url().'admum/admum_setup_pemeriksaan_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_pemeriksaan_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_pemeriksaan_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_pemeriksaan_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_pemeriksaan_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_pemeriksaan_c');
	}
