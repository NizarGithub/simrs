...
class Admum_setup_rujukan_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_supplier_obat_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_rujukan_v',
			'title' => 'Setup Rujukan Obat',
			'subtitle' => 'Setup Rujukan Obat',
			'master_menu' => 'obat',
			'view' => 'setup_rujukan',
			'childtitle' => '',
			'url_simpan' => base_url().'admum/admum_setup_rujukan_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_rujukan_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_rujukan_c/hapus',
		);
	...
	function simpan(){
		...
		redirect('admum/admum_setup_supplier_obat_c');
	}
