...
class Admum_jenis_penyakit_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_jenis_penyakit_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_jenis_penyakit_v',
			'title' => 'Jenis Penyakit',
			'subtitle' => 'Jenis Penyakit',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'jenis_penyakit',
			'url_simpan' => base_url().'admum/admum_jenis_penyakit_c/simpan',
			'url_ubah' => base_url().'admum/admum_jenis_penyakit_c/ubah',
			'url_hapus' => base_url().'admum/admum_jenis_penyakit_c/hapus',
			'url_cetak' => base_url().'admum/admum_jenis_penyakit_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_jenis_penyakit_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_jenis_penyakit_c');
	}
