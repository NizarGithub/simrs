...
class Admum_setup_satuan_obat_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_satuan_obat_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_satuan_obat_v',
			'title' => 'Setup Satuan Obat',
			'subtitle' => 'Setup Satuan Obat',
			'master_menu' => 'obat',
			'view' => 'setup_satuan_obat',
			'childtitle' => '',
			'url_simpan' => base_url().'admum/admum_setup_satuan_obat_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_satuan_obat_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_satuan_obat_c/hapus',
		);
	...
	function simpan(){
		...
		redirect('admum/admum_setup_satuan_obat_c');
	}
