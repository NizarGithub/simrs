...
class Admum_setup_loket_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_loket_m','model');
	...
	function index()
	{
		...
		$data = array(
			'page' => 'admum/admum_setup_loket_v',
			'title' => 'Setup Loket',
			...
			'post_url' => base_url().'admum/admum_setup_loket_c',
			'url_simpan' => base_url().'admum/admum_setup_loket_c',
			'url_ubah' => base_url().'admum/admum_setup_loket_c',
			'url_hapus' => base_url().'admum/admum_setup_loket_c',
		);
	...
	function edit($id){
		...
		if($this->input->post('nama_loket')){
		    ...
		    redirect('admum/admum_setup_loket_c');
		}

		$data = array(
			'page' => 'admum/admum_setup_loket_edit_v',
			'title' => 'Setup Loket',
			'subtitle' => 'Setup Loket',
			'childtitle' => '',
			'master_menu' => 'antrian',
			...
			'url_simpan' => base_url().'admum/admum_setup_loket_c/edit/'.$id,
		);
