...
class Admum_setup_kamar_rawat_inap_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_kamar_rawat_inap_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_kamar_rawat_inap_v',
			'title' => 'Setup Kamar Rawat Inap',
			'subtitle' => 'Setup Kamar Rawat Inap',
			'childtitle' => '',
			'master_menu' => 'master_setup',
			'view' => 'setup_kamar_rawat_inap',
			'url_simpan' => base_url().'admum/admum_setup_kamar_rawat_inap_c/simpan',
			'url_simpan_bed' => base_url().'admum/admum_setup_kamar_rawat_inap_c/simpan_bed',
			'url_ubah' => base_url().'admum/admum_setup_kamar_rawat_inap_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_kamar_rawat_inap_c/hapus',
			'url_hapus_bed' => base_url().'admum/admum_setup_kamar_rawat_inap_c/hapus_bed',
			'url_cetak' => base_url().'admum/admum_setup_kamar_rawat_inap_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_kamar_rawat_inap_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_kamar_rawat_inap_c');
	}
