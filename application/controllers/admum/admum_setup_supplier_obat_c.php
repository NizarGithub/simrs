...
class Admum_setup_supplier_obat_c extends CI_Controller {
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_supplier_obat_v',
			'title' => 'Setup Supplier Obat',
			'subtitle' => 'Setup Supplier Obat',
			'master_menu' => 'obat',
			'view' => 'setup_supplier_obat',
			'childtitle' => '',
			'url_simpan' => base_url().'admum/admum_setup_supplier_obat_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_supplier_obat_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_supplier_obat_c/hapus',
		);
