...
class Admum_setup_jenis_laborat_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_jenis_laborat_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_jenis_laborat_v',
			'title' => 'Setup Jenis Laborat',
			'subtitle' => 'Setup Jenis Laborat',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'jenis_laborat',
			'url_simpan' => base_url().'admum/admum_setup_jenis_laborat_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_jenis_laborat_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_jenis_laborat_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_jenis_laborat_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_jenis_laborat_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_jenis_laborat_c');
	}
