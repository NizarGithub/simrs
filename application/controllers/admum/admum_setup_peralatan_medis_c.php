...
class Admum_setup_peralatan_medis_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admum/admum_setup_peralatan_medis_m','model');
	...
	{
		$data = array(
			'page' => 'admum/admum_setup_peralatan_medis_v',
			'title' => 'Peralatan Medis',
			'subtitle' => 'Peralatan Medis',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'setup_peralatan_medis',
			'url_simpan' => base_url().'admum/admum_setup_peralatan_medis_c/simpan',
			'url_ubah' => base_url().'admum/admum_setup_peralatan_medis_c/ubah',
			'url_hapus' => base_url().'admum/admum_setup_peralatan_medis_c/hapus',
			'url_cetak' => base_url().'admum/admum_setup_peralatan_medis_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('admum/excel/excel_peralatan_medis',$data);
	}
	...
	function simpan(){
		...
		redirect('admum/admum_setup_peralatan_medis_c');
	}
