...
class Admum_setup_rujukan_c extends CI_Controller {

	function __construct()
	{
		parent::__construct();
		$this->load->model('setup/admum_setup_supplier_obat_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_setup_rujukan_v',
			'title' => 'Setup Rujukan Obat',
			'subtitle' => 'Setup Rujukan Obat',
			'master_menu' => 'setup',
			'view' => 'rujukan',
			'childtitle' => '',
			'url_simpan' => base_url().'setup/admum_setup_rujukan_c/simpan',
			'url_ubah' => base_url().'setup/admum_setup_rujukan_c/ubah',
			'url_hapus' => base_url().'setup/admum_setup_rujukan_c/hapus',
		);
	...
	function get_data_rujukan(){
		$keyword = $this->input->get('keyword');
		$data = $this->model->data_rujukan($keyword);
		echo json_encode($data);
	}

	function data_supplier_id(){
		$id = $this->input->post('id');
		$data = $this->model->data_rujukan_id($id);
		echo json_encode($data);
	}
	...
	function simpan(){
		...
		redirect('setup/admum_setup_supplier_obat_c');
	}
