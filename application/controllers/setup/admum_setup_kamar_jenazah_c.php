...
class Admum_setup_kamar_jenazah_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('setup/admum_setup_kamar_jenazah_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_setup_kamar_jenazah_v',
			'title' => 'Setup Kamar Jenazah',
			'subtitle' => 'Setup Kamar Jenazah',
			'master_menu' => 'setup_kamar',
			'view' => 'setup_kamar_jenazah',
			'childtitle' => '',
			'url_simpan' => base_url().'setup/admum_setup_kamar_jenazah_c/simpan',
			'url_simpan_lemari' => base_url().'setup/admum_setup_kamar_jenazah_c/simpan_lemari',
			'url_ubah' => base_url().'setup/admum_setup_kamar_jenazah_c/ubah',
			'url_hapus' => base_url().'setup/admum_setup_kamar_jenazah_c/hapus',
			'url_hapus_lemari' => base_url().'setup/admum_setup_kamar_jenazah_c/hapus_lemari',
			'url_cetak' => base_url().'setup/admum_setup_kamar_jenazah_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('setup/excel/excel_kamar_jenazah_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('setup/admum_setup_kamar_jenazah_c');
	}
