...
class Admum_setup_ruang_operasi_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('setup/admum_setup_ruang_operasi_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_setup_ruang_operasi_v',
			'title' => 'Setup Ruang Operasi',
			'subtitle' => 'Setup Ruang Operasi',
			'master_menu' => 'setup_kamar',
			'view' => 'ruang_operasi',
			'childtitle' => '',
			'url_simpan' => base_url().'setup/admum_setup_ruang_operasi_c/simpan',
			'url_ubah' => base_url().'setup/admum_setup_ruang_operasi_c/ubah',
			'url_hapus' => base_url().'setup/admum_setup_ruang_operasi_c/hapus',
		);
	...
	function simpan(){
		...
		redirect('setup/admum_setup_ruang_operasi_c');
	}
