...
class Admum_kasus_diagnosa_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('setup/admum_kasus_diagnosa_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_kasus_diagnosa_v',
			'title' => 'Setup Kasus Diagnosa',
			'subtitle' => 'Setup Kasus Diagnosa',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'kasus',
			'url_simpan' => base_url().'setup/admum_kasus_diagnosa_c/simpan',
			'url_ubah' => base_url().'setup/admum_kasus_diagnosa_c/ubah',
			'url_hapus' => base_url().'setup/admum_kasus_diagnosa_c/hapus',
			'url_cetak' => base_url().'setup/admum_kasus_diagnosa_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('setup/excel/excel_kasus_diagnosa_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('setup/admum_kasus_diagnosa_c');
	}
