...
class Admum_spesialistik_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('setup/admum_spesialistik_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_spesialistik_v',
			'title' => 'Setup Spesialistik',
			'subtitle' => 'Setup Spesialistik',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'spesialistik',
			'url_simpan' => base_url().'setup/admum_spesialistik_c/simpan',
			'url_ubah' => base_url().'setup/admum_spesialistik_c/ubah',
			'url_hapus' => base_url().'setup/admum_spesialistik_c/hapus',
			'url_cetak' => base_url().'setup/admum_spesialistik_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('setup/excel/excel_spesialistik_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('setup/admum_spesialistik_c');
	}
