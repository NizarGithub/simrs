...
class Admum_icu_c extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('setup/admum_icu_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_icu_v',
			'title' => 'Setup Ruang ICU',
			'subtitle' => 'Setup Ruang ICU',
			'master_menu' => 'setup_kamar',
			'view' => 'icu',
			'childtitle' => '',
			'url_simpan' => base_url().'setup/admum_icu_c/simpan',
			'url_ubah' => base_url().'setup/admum_icu_c/ubah',
			'url_hapus' => base_url().'setup/admum_icu_c/hapus',
		);
