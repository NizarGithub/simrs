...
class Admum_ambulance_c extends CI_Controller {
	...
	{
		parent::__construct(); 
		$this->load->model('setup/admum_ambulance_m','model');
	...
	{
		$data = array(
			'page' => 'setup/admum_ambulance_v',
			'title' => 'Ambulance',
			'subtitle' => 'Ambulance',
			'childtitle' => '',
			'master_menu' => 'setup',
			'view' => 'ambulance',
			'url_simpan' => base_url().'setup/admum_ambulance_c/simpan',
			'url_ubah' => base_url().'setup/admum_ambulance_c/ubah',
			'url_hapus' => base_url().'setup/admum_ambulance_c/hapus',
			'url_cetak' => base_url().'setup/admum_ambulance_c/cetak_excel',
		);
	...
	function cetak_excel(){
		...
		$this->load->view('setup/excel/excel_data_ambulance_xls',$data);
	}
	...
	function simpan(){
		...
		redirect('setup/admum_ambulance_c');
	}
