...
class Lap_rj_per_wilayah_c extends CI_Controller {
	...
	{
		$data = array(
			'page' => 'rekam_medik/lap_rj_per_wilayah_v',
			'title' => 'Laporan Pasien Per Wilayah',
			'subtitle' => 'Laporan Pasien Per Wilayah',
	...
	function cetak_pdf(){
		...
		$this->load->view('rekam_medik/pdf/lap_rj_per_wilayah_pdf_v',$array);
	}
	...
	function cetak_excel(){
		...
		$this->load->view('rekam_medik/excel/lap_rj_per_wilayah_xls_v',$array);
	}
