...
class Lap_rj_total_kunjungan_c extends CI_Controller {
	...
	{
		$data = array(
			'page' => 'rekam_medik/lap_rj_total_kunjungan_v',
			'title' => 'Laporan Total Kunjungan Pasien',
			'subtitle' => 'Laporan Total Kunjungan Pasien',
			'master_menu' => 'rawat_jalan',
			'view' => 'total_kunjungan'
		);
	...
	function cetak_pdf(){
		...
		$array = array(
			'dt' => $data,
			'judul' => $judul,
			'settitle' => 'Laporan Total Kunjungan Pasien',
			'filename' => date('dmY').'_lap_total_kunjungan'
		);

		$this->load->view('rekam_medik/pdf/lap_rj_total_kunjungan_pdf_v',$array);
	}
	...
	function cetak_excel(){
		...
		$this->load->view('rekam_medik/excel/lap_rj_total_kunjungan_xls_v',$array);
	}
