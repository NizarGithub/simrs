...
class Rk_pelayanan_rj_c extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('rekam_medik/rk_pelayanan_rj_m','model');
	...
	{
		$data = array(
			'page' => 'rekam_medik/rk_pelayanan_rj_v',
	...
	function tindakan_rj($id){
		$data = array(
			'page' => 'rekam_medik/rk_tindakan_rj_v',
			'title' => 'Pelayanan Rawat Jalan',
			'subtitle' => 'Pelayanan Rawat Jalan',
			'master_menu' => 'pelayanan',
			'view' => 'pelayanan_rj',
			...
			'id' => $id,
			'url_simpan' => base_url().'rekam_medik/rk_pelayanan_rj_c/simpan_tindakan',
			'url_ubah' => base_url().'rekam_medik/rk_pelayanan_rj_c/ubah_tindakan',
			'url_hapus' => base_url().'rekam_medik/rk_pelayanan_rj_c/hapus_tindakan',
		);
	...
	function simpan_tindakan(){
		...
		redirect('rekam_medik/rk_pelayanan_rj_c/tindakan_rj/'.$id); 
	}
	...
	function ubah_tindakan(){
		...
		redirect('rekam_medik/rk_pelayanan_rj_c/tindakan_rj/'.$id_pelayanan);
	}
	...
	function simpan_spesialistik(){
		...
		$this->model->simpan_diagnosa($id_pelayanan,$id_poli,$id_peg_dokter,$id_pasien,$tanggal,$bulan,$tahun,$diagnosa,$tindakan,$kasus,$spesialistik);
	...
	function simpan_resep(){
		...
		$this->model->simpan_resep($id_pelayanan,$id_poli,$id_peg_dokter,$id_pasien,$kode_resep,$diminum_selama,$tanggal,$bulan,$tahun);
	...
	function surat_dokter($id){
		...
		$this->load->view('rekam_medik/pdf/rk_surat_dokter_rj_pdf_v',$data);
	}
