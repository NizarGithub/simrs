...
class Lap_rj_kunj_lama_c extends CI_Controller {
	...
	{
		$data = array(
			'page' => 'rekam_medik/lap_rj_kunj_lama_v',
			'title' => 'Laporan Kunjungan Pasien Lama',
			'subtitle' => 'Laporan Kunjungan Pasien Lama',
	...
	function cetak_pdf(){
		...
		$array = array(
			'dt' => $data,
			'judul' => $judul,
			'settitle' => 'Laporan Kunjungan Pasien Lama',
			'filename' => date('dmY').'_lap_kunj_pasien_lama'
		);

		$this->load->view('rekam_medik/pdf/lap_rj_kunj_lama_pdf_v',$array);
	}
	...
	function cetak_excel(){
		...
		$this->load->view('rekam_medik/excel/lap_rj_kunj_lama_xls_v',$array);
	}
