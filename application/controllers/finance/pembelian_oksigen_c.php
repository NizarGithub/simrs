...
class Pembelian_oksigen_c extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('finance/pembelian_oksigen_m','model');
	...
	{
		$data = array(
			'page' => 'finance/pembelian_oksigen_v',
			'title' => 'Pembelian Oksigen',
			'subtitle' => 'Pembelian Oksigen',
			'childtitle' => '',
			'master_menu' => 'pengadaan_barang',
			'view' => 'pembelian_oksigen'
		);
	...
	function simpan(){
		...
		redirect('finance/pembelian_oksigen_c');
	}
	...
	function cetak_excel(){
		...
		$data = array(
			...
			'bulan' => $bulan,
			'tahun' => $tahun,
			'settitle' => 'Laporan Pembelian Oksigen',
			'filename' => date('dmY').'_lap_pembelian_oksigen'
		);

		$this->load->view('finance/xls/lap_pembelian_oksigen_xls_v',$data);
	}
	...
	function cetak_pdf(){
		...
		$this->load->view('finance/pdf/lap_pembelian_oksigen_pdf_v',$data);
	}
