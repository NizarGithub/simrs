...
class Pembelian_club_c extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('finance/pembelian_club_m','model');
	...
	{
		$data = array(
			'page' => 'finance/pembelian_club_v',
			'title' => 'Pembelian Club',
			'subtitle' => 'Pembelian Club',
			'childtitle' => '',
	...
	function simpan(){
		...
		redirect('finance/pembelian_club_c');
	}
	...
	function cetak_excel(){
		...
		$data = array(
			...
			'bulan' => $bulan,
			'tahun' => $tahun,
			'settitle' => 'Laporan Pembelian Club',
			'filename' => date('dmY').'_lap_pembelian_club'
		);

		$this->load->view('finance/xls/lap_pembelian_club_xls_v',$data);
	}
	...
	function cetak_pdf(){
		...
		$this->load->view('finance/pdf/lap_pembelian_club_pdf_v',$data);
	}
