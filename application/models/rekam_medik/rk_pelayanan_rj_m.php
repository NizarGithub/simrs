...
class Rk_pelayanan_rj_m extends CI_Model {
	...
	function simpan_diagnosa($id_pelayanan,$id_poli,$id_peg_dokter,$id_pasien,$tanggal,$bulan,$tahun,$diagnosa,$tindakan,$kasus,$spesialistik){
		$sql = "
	...
	function simpan_resep($id_pelayanan,$id_poli,$id_peg_dokter,$id_pasien,$kode_resep,$diminum_selama,$tanggal,$bulan,$tahun){
		$sql = "
