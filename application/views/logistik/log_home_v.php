...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>picture/plus.gif">
    ...
    <body>
        ...
        <!-- Navigation Bar-->
        <header id="topnav">
            <div class="topbar-main" style="background-color:#ffb310; height:60px;">
                <div class="container">

                    <!-- LOGO -->
                    <div class="topbar-left">
                        <a href="<?php echo base_url(); ?>logistik/log_home_c" class="logo" style="margin-top:4px;">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li <?php if($master_menu == 'home'){ echo 'class="active"';}else{echo '';} ?> >
                                <a href="<?php echo base_url(); ?>logistik/log_home_c">
