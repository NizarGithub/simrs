...
$(document).ready(function(){
	...
	$('#btn_kembali').click(function(){
		window.location = "<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c";
	});
	...
	$('#btn_tambah_lab').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/get_kode_lab',
			type : "POST",
			dataType : "json",
	...
	$('#simpanLab').click(function(){
		...
		if(id_laborat == ""){
			...
			$.ajax({
				url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/simpan_pemeriksaan',
	...
	$('#ya_lab').click(function(){
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/hapus_laborat',
	...
	$('#simpanDg').click(function(){
		...
		if(diagnosa == ""){
			...
			$.ajax({
				url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/simpan_spesialistik',
	...
	$('#simpanDgUbah').click(function(){
		...
		if(diagnosa == ""){
			...
			$.ajax({
				url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/ubah_diagnosa',
	...
	$('#ya_dg').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/hapus_diagnosa',
	...
	$('#btn_tambah_resep').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/get_kode_resep',
			type : "POST",
			dataType : "json",
			success : function(kode){
				$('#kode_resep').val(kode);
	...
	$('#simpanResep').click(function(){
		...
		if(tr == 0){
			...
			$.ajax({
				url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/simpan_resep',
	...
	$('#ya_resep').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/hapus_resep',
			data : {id:id,id_pelayanan:id_pelayanan},
			type : "POST",
			dataType : "json",
			success : function(kode){
	...
	$('#simpanKA').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/simpan_kondisi',
    ...
    $('#simpanSD').click(function(){
    	...
    	if(waktu == ""){
    		...
    		$.ajax({
				url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/simpan_surat_dokter',
    ...
    $('#ya_sd').click(function(){
    	$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/hapus_surat_dokter',
...
function load_tindakan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_tindakan',
...
function klik_tindakan(id){
	...
	if(id_ubah == ""){
		$.ajax({
			url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_tindakan',
			data : {id:id},
			type : "POST",
			dataType : "json",
			success : function(result){
...
function data_tindakan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_tindakan',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function ubah_tindakan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_tindakan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_laborat(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_laborat',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function klik_laborat(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_laborat',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_pemeriksaan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_pemeriksaan',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function klik_pemeriksaan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_pemeriksaan',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function data_laborat(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_laborat',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
			...
			if(result == "" || result == null){
				...
				for(var i=0; i<result.length; i++){
					...
					$tr += "<tr>"+
								...
								"<td align='center'>"+
									"<a href='<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/cetak_laborat/"+result[i].ID+"/"+id_pelayanan+"' class='btn btn-inverse btn-sm' target='_blank'><i class='fa fa-print'></i></a>"+
								"</td>"+
								"<td align='center'>"+aksi+"</td>"+
							"</tr>";
				}
...
function hasil_laborat(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_hasil_pemeriksaan',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function hapus_laborat(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_laborat_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_kasus_diagnosa(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_kasus',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function klik_kasus(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_kasus_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_spesialistik_diagnosa(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_spesialistik',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function klik_spesialistik(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_spesialistik_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function data_diagnosa(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_diagnosa',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function ubah_diagnosa(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_diagnosa_id',
		data : {id:id,id_pelayanan:id_pelayanan},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_obat(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_resep',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function klik_obat(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_resep',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
			...
			for(var i=0; i<result.length; i++){
				...
				if(jumlah_data > 0){
					...
					$tr = "<tr id='tr_resep2_"+result[i].ID+"'>"+
							...
							"<input type='hidden' name='harga_obat[]' value='"+result[i].HARGA_JUAL+"'>"+
							"<td>"+result[i].KODE_OBAT+"</td>"+
							"<td>"+result[i].NAMA_OBAT+"</td>"+
							"<td><input type='text' class='form-control' name='jumlah_obat[]' value='' style='width:125px;'></td>"+
...
function data_resep(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_resep',
...
function detail_resep(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/detail_resep',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function hapus_resep(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_resep_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function load_ruangan(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_ruangan',
...
function klik_ruangan(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_ruangan',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function load_bed(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_bed',
...
function klik_bed(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_bed',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function load_ruang_icu(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_ruang_icu',
        data : {keyword:keyword},
        type : "POST",
        dataType : "json",
        success : function(result){
...
function klik_ruang_icu(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_ruang_icu',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function load_ruang_operasi(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_ruang_operasi',
        data : {keyword:keyword},
        type : "POST",
        dataType : "json",
        success : function(result){
...
function klik_ruang_operasi(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_ruang_operasi',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function load_kamar_jenazah(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_kamar_jenazah',
        data : {keyword:keyword},
        type : "POST",
        dataType : "json",
        success : function(result){
...
function klik_kamar_jenazah(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_kamar_jenazah',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function load_lemari_jenazah(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/load_lemari_jenazah',
...
function klik_lemari_jenazah(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/klik_lemari_jenazah',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
function data_surat_dokter(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_surat_dokter',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(result){
...
function surat_dokter(id){
    window.open('<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/surat_dokter/'+id, '_blank');
    // prt.print();
}
...
function hapus_surat_dokter(id){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/rk_pelayanan_rj_c/data_surat_dokter_id',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
