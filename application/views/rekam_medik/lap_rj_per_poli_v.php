...
function get_data(){
    ...
    ajax = $.ajax({
        url : '<?php echo base_url(); ?>rekam_medik/lap_rj_per_poli_c/get_data',
        data : {
            id_poli:id_poli,
        ...
        success : function(result){
            ...
            if(result == "" || result == null){
                ...
                for(var i=0; i<result.length; i++){
                    ...
                    var poli = result[i].NAMA+' - '+result[i].STATUS;

                    $tr += "<tr>"+
                                "<td style='vertical-align:middle; text-align:center;'>"+no+"</td>"+
                                "<td style='vertical-align:middle;'>"+poli+"</td>"+
        ...
        <div class="card-box">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                    <form class="form-horizontal" role="form" method="post" target="_blank" action="<?php echo base_url(); ?>rekam_medik/lap_rj_per_poli_c/cetak">
                        <div class="form-group">
                            <label class="col-sm-1 control-label" style="text-align: left;">Pilih Poli</label>
                            <div class="col-sm-4">
                                <?php
                                    $s_poli = "SELECT * FROM admum_poli";
                                    $q_poli = $this->db->query($s_poli)->result();
                                ?>
                                <select class="form-control" id="poli" name="poli">
                                    <option value="Semua">Semua Poli</option>
                                <?php
                                    foreach ($q_poli as $key => $value) {
                                ?>
                                    <option value="<?php echo $value->ID; ?>"><?php echo $value->NAMA.' - '.$value->STATUS; ?></option>
                                <?php
                                    }
                                ?>
                                </select>
    	                                ...
    	                                <table class="table table-hover table-bordered" id="tabel_data">
    	                                    <thead>
    	                                        <tr class="merah">
                                                    ...
                                                    <th style="color:#fff; text-align:center; vertical-align: middle;">Poli</th>
                                                    <th style="color:#fff; text-align:center; vertical-align: middle;">Keterangan</th>
