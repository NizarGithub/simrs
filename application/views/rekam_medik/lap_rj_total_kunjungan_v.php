...
function get_data(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>rekam_medik/lap_rj_total_kunjungan_c/get_data',
		data : {
        ...
        <div class="card-box">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                    <form class="form-horizontal" role="form" method="post" target="_blank" action="<?php echo base_url(); ?>rekam_medik/lap_rj_total_kunjungan_c/cetak">
