...
<table align="left" class="grid">
    ...
    <tbody>
        ...
        foreach ($dt as $value) {
            ...
            $poli = $value->NAMA.' - '.$value->STATUS;
        ?>
        <tr>
            <td style="width:30px; text-align: center;"><?php echo $no; ?></td>
            <td style="width: 320px;"><?php echo $poli; ?></td>
            <td style="width: 215px;"><?php echo $value->KETERANGAN; ?></td>
            <td style="width: 100px; text-align:center;"><?php echo $value->JUMLAH_PASIEN; ?></td>
        </tr>
        <?php
            }
        ?>
        <tr>
            ...
            <td style="text-align: center; font-weight: bold; font-size: 11px;"><?php echo number_format($total,0,'.',','); ?></td>
        </tr>
    </tbody>
</table>
