...
<table align="left" class="grid">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 100px; text-align:center;"><?php echo $value->TANGGAL_DAFTAR; ?></td>
            <td style="width: 100px; text-align: center;"><?php echo $value->KODE_PASIEN; ?></td>
            <td style="width: 220px;"><?php echo $value->NAMA; ?></td>
            <td style="width: 100px; text-align:center;"><?php echo $value->JENIS_KELAMIN; ?></td>
            <td style="width: 70px; text-align:center;"><?php echo $value->JENIS_PASIEN; ?></td>
        </tr>
        <?php
            }
        ?>
        <tr>
            <td colspan="5" style="text-align: center; font-weight: bold; font-size: 11px;">TOTAL</td>
