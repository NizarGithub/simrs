...
<table align="center" class="grid">
    <thead>
        <tr>
            ...
            <th colspan="4" width="150" style="text-align:center;"> POLI </th>
            <th colspan="3" width="150" style="text-align:center;"> KETERANGAN </th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="4" width="150"><?php echo $poli; ?></td>
            <td colspan="3" width="150"><?php echo $value->KETERANGAN; ?></td>
