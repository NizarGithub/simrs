...
<div class="alert alert-danger alert-dismissable" style="color: #b96463; font-size: 15px;">
    ...
    Maaf, kode jabatan telah terpakai untuk jabatan lain. Silahkan pilih kode yang berbeda.
</div>
<?PHP } ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="form-horizontal" role="form" method="post" action="<?=base_url().$post_url;?>">
                        ...
                        <label class="col-md-2 control-label" style="color: #0099e5;"> Kode Jabatan </label>
                            <div class="col-md-6">
                                <input name="kode_jab" required class="form-control" value="<?=$kode_jab;?>" type="text" placeholder="Masukkan Kode Jabatan">
                            </div>
                        </div>
                        ...
                        <label class="col-md-2 control-label" style="color: #0099e5;"> Nama Jabatan </label>
                            <div class="col-md-6">
                                <input name="nama_jab" required class="form-control" value="<?=$nama_jab;?>" type="text" placeholder="Masukkan Nama Jabatan">
                            </div>
                        </div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;"> <?=$row->KODE_JABATAN;?> </td>
                        ...
                        <td style="vertical-align:middle;" align="center"> 
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a onclick="ubah_jab(<?=$row->ID;?>);" data-toggle="modal" data-target="#edit_modal" href="#"> Ubah </a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ed_kode_jab" class="control-label">Kode Jabatan</label>
                                <input id="ed_kode_jab" name="ed_kode_jab" type="text" class="form-control" readonly>
                                <input id="id_jabatan" name="id_jabatan" type="hidden" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="ed_nama_jab" class="control-label">Nama Jabatan</label>
                                <input type="text" class="form-control" id="ed_nama_jab" name="ed_nama_jab">
                            </div>
                        </div>
                    </div>
...
function ubah_jab(id) {
   $.ajax({
        url : '<?php echo base_url(); ?>kepeg/setup_jabatan_c/get_data_jabatan',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(res){
            $('#id_jabatan').val(id);
            $('#ed_kode_jab').val(res.KODE_JABATAN);
            $('#ed_nama_jab').val(res.NAMA);
