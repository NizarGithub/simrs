        ...
        <div class="card-box card-tabs">
            <ul class="nav nav-tabs coba">
                <li role="presentation" class="active">
                    <a style="background:#f4f8fb;" href="#daftar_tim_prwt" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-users"></i> Daftar Tim Perawat</a>
                </li> 
                <li role="presentation" class="">
                    <a style="background:#f4f8fb;" href="#add_tim_prwt" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus"></i> Tambah Tim Perawat</a>
                </li>
            </ul>

            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="daftar_tim_prwt">
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center;">TG. JAWAB KAMAR</th>
                                    ...
                                    <tbody>
                                    	...
                                    	foreach ($dt as $key => $row) { 
                                    		...
                                    		$dt_kamar = $this->model->getKamarTim($row->ID);
                                    	?>
                                    		<tr>
                                    			<td style="vertical-align:top;"><b><?=$row->NAMA_TIM;?></b></td>
                                    			<td style="vertical-align:top;"><?=$row->KETUA;?></td>
                                    			...
                                    			<td style="vertical-align:top;">
                                    				<?PHP foreach ($dt_kamar as $key => $kmr) {
                                    					echo "- <b>(".$kmr->KODE_KAMAR.")</b> ".$kmr->NAMA_KAMAR." <br> ";
                                    				} ?>
                                    			</td>
                                    			<td style="vertical-align:top;" align="center">
                                    				<a class="btn btn-warning" href="<?=base_url();?>kepeg/setup_tim_perawat_c/ubah/<?=$row->ID;?>"> <i class="fa fa-edit"></i> </a>
                ...
                <div role="tabpanel" class="tab-pane fade" id="add_tim_prwt">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <div class="row"> 
	                            	<div class="form-group">
				                        ...
				                        <div class="col-md-6">
				                            <input type="text" class="form-control" name="nama_tim" id="nama_tim" value="" required="required">
				                        </div>
				                    </div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input id="nama_ketua" name="nama_ketua" class="form-control" type="text" readonly value="" style="background:#FFF;">
                                            ...
                                            <input name="id_ketua" id="id_ketua" class="form-control" value="" type="hidden">
                                        </div>
                                    </div>                          
