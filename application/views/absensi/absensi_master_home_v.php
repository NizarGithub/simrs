...
<html>
    ...
    <body>
        ...
        <!-- Navigation Bar-->
        <header id="topnav">
            <div class="topbar-main" style="background-color:#1ca0de; height:60px;">
                <div class="container">
                   ...
                   <div class="topbar-left">
                    ...
                    <div class="menu-extras">  
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right" style="background-color:#2c77dc;">
                            <li>
                        ...
                        <div class="menu-item">
                            ...
                            <!-- Allah Tuhanku, Islam Agamaku, Surga Tujuanku -->
                        </div>
                    </div>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">                            
                            <li <?php if($master_menu == 'home'){ echo 'class="active"';}else{echo '';} ?> >
                                <a href="<?php echo base_url(); ?>absensi/absensi_home_c">
