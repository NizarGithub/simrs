...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>setup/admum_kasus_diagnosa_c";
	});
...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_kasus_diagnosa_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_kasus_diagnosa_c/data_kasus',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_kasus_diagnosa_c/data_kasus_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			$('#nama_kasus_ubah').val(row['NAMA_KASUS']);
		}
	});
...
function hapus(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			$('#msg').html('Apakah data <b>'+row['NAMA_KASUS']+'</b> ingin dihapus?');
		}
	});
}
</script>
		...
		<div class="row">
			<ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#home1" role="tab" data-toggle="tab"><i class="fa fa-table"></i> Data Kasus Diagnosa</a>
                </li>
                	...
                	<form class="form-horizontal" role="form" action="<?php echo $url_simpan; ?>" method="post">
                		<div class="card-box">
				            <div class="row">
			                    ...
			                    <div class="form-group">
			                        <label class="col-md-2 control-label">Nama Kasus</label>
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="nama_kasus" value="" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Nama Kasus</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="nama_kasus_ubah" id="nama_kasus_ubah" value="" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">&nbsp;</label>
