...
$(document).ready(function(){
    ...
    $('#batal').click(function(){
    	window.location = "<?php echo base_url(); ?>setup/admum_setup_jenis_laborat_c";
    });
}); 
...
function paging($selector){
    ...
    {
        $selector = $("#tabel_jenis_lab tbody tr");
    }
...
function data_jenis_laborat(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_jenis_laborat_c/data_jenis_laborat',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_jenis_laborat_c/data_jenis_laborat_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			$('#id_ubah').val(id);
			$('#jenis_laborat_ubah').val(row['JENIS_LABORAT']);
		}
	});
...
function hapus(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			$('#msg').html('Apakah data <b>'+row['JENIS_LABORAT']+'</b> ingin dihapus?');
		}
	});
}
</script>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                	...
                	<div class="table-responsive">
			            <table id="tabel_jenis_lab" class="table table-bordered">
			                <thead>
			                    <tr class="biru">
                		...
                		<div class="card-box">
				            <div class="row">
				            	<div class="form-group">
			                        ...
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="jenis_laborat" value="">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
		            	<div class="form-group">
	                        <label class="col-md-2 control-label">Jenis Laborat</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="jenis_laborat_ubah" id="jenis_laborat_ubah" value="">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">&nbsp;</label>
