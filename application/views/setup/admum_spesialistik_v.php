...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>setup/admum_spesialistik_c";
	});
...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_spesialistik_c/get_kode',
		type : "POST",
		dataType : "json",
...
function paging($selector){
    ...
    {
        $selector = $("#tabel_spesialistik tbody tr");
    }
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_spesialistik_c/data_spesialistik',
		...
		success : function(result){
			...
			$('#tabel_spesialistik tbody').html($tr);
			paging();
			$('#popup_load').fadeOut();
		}
	});
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_spesialistik_c/data_spesialistik_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			$('#spesialistik_ubah').val(row['NAMA_SPESIALISTIK']);
		}
	});
...
function hapus(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			$('#msg').html('Apakah data <b>'+row['NAMA_SPESIALISTIK']+'</b> ingin dihapus?');
		}
	});
}
</script>
		...
		<div class="row">
			<ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#home1" role="tab" data-toggle="tab"><i class="fa fa-table"></i> Data Spesialistik</a>
                </li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                	...
                	<div class="table-responsive">
	                	<table class="table table-bordered" id="tabel_spesialistik">
	                        <thead>
	                            <tr class="biru">
                		...
                		<div class="card-box">
				            <div class="row">
			                    ...
			                    <div class="form-group">
			                        ...
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="spesialistik" value="" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Spesialistik</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="spesialistik_ubah" id="spesialistik_ubah" value="" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">&nbsp;</label>
