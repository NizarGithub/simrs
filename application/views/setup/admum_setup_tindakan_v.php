...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_tindakan_c/get_kode',
		type : "POST",
		dataType : "json",
...
function data_tindakan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_tindakan_c/data_tindakan',
...
function ubah_tindakan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_tindakan_c/data_tindakan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
