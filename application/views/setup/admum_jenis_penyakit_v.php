...
function get_kode(){
	$.ajax({
        url : '<?php echo base_url(); ?>setup/admum_jenis_penyakit_c/kode',
        type : "POST",
        dataType : "json",
...
function data_jenis_penyakit(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>setup/admum_jenis_penyakit_c/data_jenis_penyakit',
...
function ubah_jenis(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_jenis_penyakit_c/data_jenis_penyakit_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
