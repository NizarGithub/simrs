<?php  
	...
	header("Content-Disposition: attachment; filename=Data_spesialistik.xls");
?>
...
<table border="1">
    <thead>
        <tr>
            ...
            <th style="height:30px; text-align:center;">Spesialistik</th>
        </tr>
    </thead>
    <tbody>
    <?php
	...
	?>
		<tr>
			...
			<td style="height:25px;"><?php echo $val->NAMA_SPESIALISTIK; ?></td>
		</tr>
	<?php	
		}
	}
