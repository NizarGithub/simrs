<?php  
	...
	header("Content-Disposition: attachment; filename=Data_gizi.xls");
?>
...
<table border="1">
    <thead>
        <tr>
            ...
            <th style="height:30px; text-align:center;">Gizi</th>
	...
	?>
		<tr>
			...
			<td style="height:25px;"><?php echo $val->NAMA_GIZI; ?></td>
			<td style="height:25px;"><?php echo $val->TARIF; ?></td>
		</tr>
	<?php	
		}
	}
