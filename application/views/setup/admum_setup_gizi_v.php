...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>setup/admum_setup_gizi_c";
	});
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_gizi_c/data_gizi',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_gizi_c/data_gizi_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
