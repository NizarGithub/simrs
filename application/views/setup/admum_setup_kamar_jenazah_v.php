...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c";
	});
	...
	$('#btn_hapus_lemari').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/hapus_lemari',
			data : {
			...
			success : function(result){
				...
				$.ajax({
					url : '<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/data_lemari',
					data : {id:id},
					type : "POST",
					dataType : "json",
					success : function(result){
						...
						for(var i=0; i<result['lemari'].length; i++){
							...
							$div += '<div class="col-lg-3">'+
								    ...
								    '        <div>'+
								    '            <img alt="user" class="img-responsive img-circle" src="<?php echo base_url(); ?>picture/setup/file-cabinet-hi.png">'+
...
function get_kode_kamar(){
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/kode_kamar',
		type : "POST",
		dataType : "json",
...
function data_kamar(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/data_kamar_jenazah',
		data : {
			keyword:keyword,
			urutkan:urutkan
		},
...
function tambah_lemari(id){
	...
	$.ajax({
		url : "<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/data_kamar_jenazah_id",
		data : {id:id},
		type : "POST",
		dataType : "json",
...
function hapus_lemari(id,id_kamar){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_kamar_jenazah_c/data_lemari_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
