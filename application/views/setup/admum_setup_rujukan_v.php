...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>setup/admum_setup_supplier_obat_c";
	});
...
function get_kode_supplier(){
	$.ajax({
        url : '<?php echo base_url(); ?>setup/admum_setup_supplier_obat_c/kode_supplier_obat',
        type : "POST",
        dataType : "json",
...
function data_supplier(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>setup/admum_setup_rujukan_c/get_data_rujukan',
...
function ubah_supplier(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_rujukan_c/data_supplier_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
...
function hapus_supplier(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_supplier_obat_c/data_supplier_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
<div class="col-lg-12">
    <div class="card-box card-tabs" id="view_data">
    	<ul class="nav nav-pills">
            <li class="active">
                <a href="#cardpills-1" data-toggle="tab" aria-expanded="true">Data Rujukan</a>
            </li>
            <li>
                <a href="#cardpills-2" data-toggle="tab" aria-expanded="false">Tambah Rujukan</a>
            </li>
        </ul>
		            ...
		            <table id="tabel_supplier" class="table table-striped table-bordered">
		                <thead>
		                    <tr class="biru">
		                        ...
		                        <th style="color:#fff; text-align:center;">Kode Rujukan</th>
		                        <th style="color:#fff; text-align:center;">Nama Rujukan</th>
            	...
            	<div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="<?php echo $url_simpan; ?>" method="post">
                        	<div class="form-group">
		                        <label class="col-md-2 control-label">Kode Rujukan</label>
		                        <div class="col-md-4">
		                            <input type="text" class="form-control" name="kode_supplier" id="kode_supplier" value="" readonly>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-md-2 control-label">Nama Rujukan</label>
		                        <div class="col-md-4">
