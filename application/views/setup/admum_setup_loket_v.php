...
function data_loket(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_loket_c/data_loket',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
...
function hapus_loket(id){
	$('#popup_hapus').click();
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_loket_c/data_loket_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function detail_operator(id, nama_loket){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_loket_c/data_detail_operator',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(result){
