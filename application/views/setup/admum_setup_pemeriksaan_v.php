...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_pemeriksaan_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_pemeriksaan_c/data_pemeriksaan',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>setup/admum_setup_pemeriksaan_c/data_pemeriksaan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
