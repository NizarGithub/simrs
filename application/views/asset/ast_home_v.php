...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>picture/portal/Iconshock-Super-Vista-Medical-Stethoscope.ico">
    ...
    <body>
        ...
        <!-- Navigation Bar-->
        <header id="topnav">
            <div class="topbar-main" style="background-color:#c6af92; height:60px;">
                <div class="container">

                    <!-- LOGO -->
                    <div class="topbar-left">
                        <a href="<?php echo base_url(); ?>asset/asset_c" class="logo" style="margin-top:4px;">
                    ...
                    <div class="menu-extras">
                        ...
                        ?>
                        <ul class="nav navbar-nav navbar-right pull-right" style="background-color:#765438; height:60px;">
                            <li>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li <?php if($master_menu == 'home'){ echo 'class="active"';}else{echo '';} ?> >
                                <a href="<?php echo base_url(); ?>asset/asset_c">
