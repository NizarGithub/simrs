...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_jasa_perawat_c_c";
	});
});

function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_jasa_perawat_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_jasa_perawat_c/data_jasa',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_jasa_perawat_c/data_jasa_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			$('#perawatan_ubah').val(row['PERAWATAN']);
...
function hapus(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			$('#msg').html('Apakah data <b>'+row['PERAWATAN']+'</b> ingin dihapus?');
		}
	});
}
</script>
		...
		<div class="row">
			<ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#home1" role="tab" data-toggle="tab"><i class="fa fa-table"></i> Data Jasa Perawat</a>
                </li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                	...
                	<div class="table-responsive">
	                	<table class="table table-bordered" id="tabel_jasa">
	                        <thead>
	                            <tr class="biru">
	                                <th style="color:#fff; text-align:center;" width="50">No</th>
	                                <th style="color:#fff; text-align:center;">Kode</th>
	                                <th style="color:#fff; text-align:center;">Perawatan</th>
                	...
                	<form class="form-horizontal" role="form" action="<?php echo $url_simpan; ?>" method="post">
                		<div class="card-box">
				            <div class="row">
			                    ...
			                    <div class="form-group">
			                        <label class="col-md-2 control-label">Perawatan</label>
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="perawatan" id="perawatan" value="" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Perawatan</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="perawatan_ubah" id="perawatan_ubah" value="" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Tarif</label>
