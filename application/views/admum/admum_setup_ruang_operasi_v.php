...
$(document).ready(function(){
	...
	$('#tambah_data').click(function(){
		$.ajax({
			url : '<?php echo base_url(); ?>admum/admum_setup_ruang_operasi_c/get_kode',
			type : "POST",
			dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_ruang_operasi_c/data_ruang',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_ruang_operasi_c/data_ruang_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
