...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_setup_supplier_obat_c";
	});
...
function get_kode_supplier(){
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_supplier_obat_c/kode_supplier_obat',
        type : "POST",
        dataType : "json",
...
function data_supplier(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_rujukan_c/get_data_rujukan',
...
function ubah_supplier(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_rujukan_c/data_supplier_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
...
function hapus_supplier(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_supplier_obat_c/data_supplier_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
