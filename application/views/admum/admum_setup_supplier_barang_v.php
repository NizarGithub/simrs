...
$(document).ready(function(){
    ...
    $('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_setup_supplier_barang_c";
	});
...
function get_kode_supplier(){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_supplier_barang_c/kode_supplier',
...
function data_supplier(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_supplier_barang_c/get_data_supplier',
...
function ubah_supplier(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_supplier_barang_c/data_supplier_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			if(row['JENIS_BARANG'] == 'Inventaris'){
				$('#jenis_barang_ubah option[value="Inventaris"]').attr('selected','selected');
			}else if(row['JENIS_BARANG'] == 'Peralatan Medis'){
				$('#jenis_barang_ubah option[value="Peralatan Medis"]').attr('selected','selected');
			}
		}
	});
...
<div class="col-lg-12">
	<div class="card-box card-tabs" id="view_data">
    	<ul class="nav nav-pills">
            <li class="active">
                <a href="#cardpills-1" data-toggle="tab" aria-expanded="true">Data Supplier</a>
            </li>
            <li id="btn_tambah">
                <a href="#cardpills-2" data-toggle="tab" aria-expanded="false">Tambah Supplier</a>
            </li>
        </ul>
    ...
    <div class="card-box card-tabs" id="view_ubah">
    	<form class="form-horizontal" role="form" action="<?php echo $url_ubah; ?>" method="post">
        	...
        	<div class="form-group">
            	<label class="col-md-2 control-label">Jenis Barang</label>
    			<div class="col-md-4">
        			<select name="jenis_barang_ubah" id="jenis_barang_ubah" class="form-control">
