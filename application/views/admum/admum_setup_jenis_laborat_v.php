...
$(document).ready(function(){
    ...
    $('#batal').click(function(){
    	window.location = "<?php echo base_url(); ?>admum/admum_setup_jenis_laborat_c";
    });
}); 
...
function data_jenis_laborat(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_jenis_laborat_c/data_jenis_laborat',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_jenis_laborat_c/data_jenis_laborat_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
