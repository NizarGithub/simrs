...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_setup_visite_c";
	});
...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_visite_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_visite_c/data_visite',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_visite_c/data_visite_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
