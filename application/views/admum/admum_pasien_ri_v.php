...
function load_ruangan(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_ri_c/load_ruangan',
...
function klik_ruangan(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_ri_c/klik_ruangan',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
                    ...
                    <div class="form-group" id="view_tgl_lahir1">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker-here" name="tanggal_lahir" id="tanggal_lahir" value="" required="required" data-language="en" data-date-format="dd-mm-yyyy" readonly>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-bed"></i>&nbsp;<strong>Pasien Rawat Inap</strong>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Ruang Tujuan</label>
                        <div class="col-md-9">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Kamar & Bed</label>
                        <div class="col-md-9">
                            <div class="input-group">
