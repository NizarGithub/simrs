...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_permintaan_po_c";
	});
...
function get_kode_po(){
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/get_kode_po',
        type : "POST",
        dataType : "json",
...
function get_data_permintaan(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/data_permintaan_barang',
		data : {
			bulan:bulan,
			tahun:tahun
		},
...
function get_detail_barang(id_permintaan){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/detail_barang_permintaan',
...
function dibatalkan(id){
	...
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/data_permintaan_barang_id',
        data : {id:id},
        type : "POST",
        dataType : "json",
...
function get_data_barang(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/data_peralatan',
		data : {
			keyword:keyword
		},
		type : "GET",
...
function klik_barang(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_permintaan_po_c/data_peralatan_id',
		data : {
			id:id
		},
		type : "POST",
    	...
    	<div class="card-box">
            ...
            <div class="tab-content">
                ...
                <div id="poli1" class="tab-pane fade in" role="tabpanel">
                	<form class="form-horizontal" role="form" action="<?php echo base_url(); ?>admum/admum_permintaan_po_c/simpan" method="post">
...
<div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<form action="<?php echo base_url(); ?>admum/admum_permintaan_po_c/dibatalkan" method="post">
