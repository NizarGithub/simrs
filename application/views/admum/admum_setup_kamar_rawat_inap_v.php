...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c";
	});
	...
	$('#btn_hapus_bed').click(function(){
		...
		$.ajax({
			url : '<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/hapus_bed',
			...
			success : function(result){
				...
				$.ajax({
					url : '<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/data_bed',
					data : {id:id},
					type : "POST",
					dataType : "json",
					async : false,
...
function get_kode_kamar(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/kode_kamar',
		type : "POST",
		dataType : "json",
...
function data_kamar(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/data_kamar',
		data : {
			keyword:keyword,
			urutkan:urutkan,
...
function tambah_bed(id){
	...
	$.ajax({
		url : "<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/data_kamar_id",
		data : {id:id},
		type : "POST",
		dataType : "json",
...
function hapus_bed(id,id_kamar){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_kamar_rawat_inap_c/data_bed_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
