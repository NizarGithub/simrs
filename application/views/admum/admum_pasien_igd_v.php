...
$(document).ready(function(){
    ...
    $('#batal').click(function(){
        window.location = "<?php echo base_url(); ?>admum/admum_pasien_igd_c";
    });
...
function get_biaya_reg(status){
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_igd_c/get_biaya_reg',
        data : {status:status},
        type : "POST",
        dataType : "json",
...
function get_kode_pasien(){
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_igd_c/kode_pasien',
        type : "POST",
        dataType : "json",
...
function data_provinsi(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_igd_c/data_provinsi',
...
function load_data_pasien(){
    ...
    ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_igd_c/load_data_pasien',
...
function klik_pasien(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_pasien_igd_c/klik_pasien',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            <i class="fa fa-plus-square"></i>&nbsp;<strong>Pasien Instalasi Gawat Darurat</strong>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
