...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_tindakan_c/get_kode',
		type : "POST",
		dataType : "json",
...
function paging($selector){
    ...
    {
        $selector = $("#tabel_tindakan tbody tr");
    }
...
function data_tindakan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_tindakan_c/data_tindakan',
		...
		success : function(result){
			...
			if(result == "" || result == null){
				...
				for(var i=0; i<result.length; i++){
					...
					var aksi =  '<button type="button" class="btn btn-success btn-sm m-b-5" onclick="ubah_tindakan('+result[i].ID+');">'+
                                    '<i class="fa fa-pencil"></i>'+
                                '</button>&nbsp;'+
                                '<button type="button" class="btn btn-danger btn-sm m-b-5" onclick="hapus_tindakan('+result[i].ID+');">'+
...
function ubah_tindakan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_tindakan_c/data_tindakan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			$('#nama_tindakan_ubah').val(row['NAMA_TINDAKAN']);
...
function hapus_tindakan(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			var text = row['KODE']+' - '+row['NAMA_TINDAKAN'];
            $('#msg').html('Apakah tindakan ini <b>'+text+'</b> ingin dihapus?');
		}
	});
}
</script>
		...
		<div class="row">
			<ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#home1" role="tab" data-toggle="tab"><i class="fa fa-table"></i> Data Tindakan</a>
                </li>
	                	...
	                	<div class="form-group">
			                ...
			                <div class="col-md-4">
				                ...
				                <div class="input-group">
				                    <input type="text" class="form-control" id="cari_tindakan" placeholder="Cari..." value="" onkeypress="return onEnterText(event);">
			            ...
			            <table id="tabel_tindakan" class="table table-bordered">
			                <thead>
			                    <tr class="biru">
			                        ...
			                        <th style="color:#fff; text-align:center;">Nama Tindakan</th>
                		...
                		<div class="card-box">
				            <div class="row">
			                    ...
			                    <div class="form-group">
			                        ...
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="nama_tindakan" value="" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
			                        <label class="col-md-2 control-label">Tarif</label>
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="tarif" value="" onkeyup="FormatCurrency(this);" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Nama Tindakan</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="nama_tindakan_ubah" id="nama_tindakan_ubah" value="" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Tarif</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="tarif_ubah" id="tarif_ubah" value="" onkeyup="FormatCurrency(this);" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">&nbsp;</label>
