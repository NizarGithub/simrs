...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_kasus_diagnosa_c";
	});
...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_kasus_diagnosa_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_kasus_diagnosa_c/data_kasus',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_kasus_diagnosa_c/data_kasus_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
