...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c";
	});
...
function get_kode_peralatan(){
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/kode_peralatan',
        type : "POST",
        dataType : "json",
...
function get_merk(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/data_merk',
...
function klik_merk(id_merk){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/klik_merk',
...
function data_peralatan(){
	...
	ajax = $.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/get_data_alat',
        data : {keyword:keyword},
        type : "GET",
        dataType : "json",
        success : function(result){
...
function ubah_alat(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/data_alat_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
...
function cek_barcode(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_peralatan_medis_c/cek_barcode',
