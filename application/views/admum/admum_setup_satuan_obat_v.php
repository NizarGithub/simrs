...
function get_kode_satuan(){
	$.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_satuan_obat_c/kode_satuan_obat',
        type : "POST",
        dataType : "json",
...
function data_satuan(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_setup_satuan_obat_c/get_data_satuan',
...
function ubah_satuan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_satuan_obat_c/data_satuan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
