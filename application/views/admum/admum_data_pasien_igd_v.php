...
function data_pasien(){
    ...
    ajax = $.ajax({
        url : '<?php echo base_url(); ?>admum/admum_data_pasien_c/data_pasien_igd',
        data : {
            keyword:keyword,
            urutkan:urutkan,
...
<div class="col-lg-12" id="view_data">
	<div class="card-box">
		<form class="form-horizontal" role="form" action="<?php echo $url_cetak; ?>" method="post" target="blank">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
	                ...
	                <div class="input-group">
	                    <input type="text" class="form-control" id="cari_pasien" placeholder="Cari..." value="" onkeypress="return onEnterText(event);">
            ...
            <div class="form-group" id="view_umur">
                ...
                <div class="col-md-3">
                    <select class="form-control" id="pilih_umur">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <!-- <button type="submit" class="btn btn-success waves-effect w-md waves-light m-b-5"><i class="fa fa-file-text-o"></i> <b>Cetak Excel</b></button> -->
                </div>
