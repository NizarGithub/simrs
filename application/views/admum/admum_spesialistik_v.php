...
$(document).ready(function(){
	...
	$('#batal').click(function(){
		window.location = "<?php echo base_url(); ?>admum/admum_spesialistik_c";
	});
...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_spesialistik_c/get_kode',
		type : "POST",
		dataType : "json",
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_spesialistik_c/data_spesialistik',
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_spesialistik_c/data_spesialistik_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
