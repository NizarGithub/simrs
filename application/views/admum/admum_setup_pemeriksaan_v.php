...
function get_kode(){
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_pemeriksaan_c/get_kode',
		type : "POST",
		dataType : "json",
...
function paging($selector){
    ...
    {
        $selector = $("#tabel_pemeriksaan tbody tr");
    }
...
function get_data(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_pemeriksaan_c/data_pemeriksaan',
		...
		success : function(result){
			...
			$('#tabel_pemeriksaan tbody').html($tr);
			paging();
			$('#popup_load').fadeOut();
		}
	});
...
function ubah(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>admum/admum_setup_pemeriksaan_c/data_pemeriksaan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		success : function(row){
			...
			$('#keterangan_ubah').val(row['NAMA_PEMERIKSAAN']);
...
function hapus(id){
	...
	$.ajax({
		...
		success : function(row){
			$('#id_hapus').val(id);
			$('#msg').html('Apakah data <b>'+row['NAMA_PEMERIKSAAN']+'</b> ingin dihapus?');
		}
	});
}
</script>
		...
		<div class="row">
			<ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#home1" role="tab" data-toggle="tab"><i class="fa fa-table"></i> Data Pemeriksaan</a>
                </li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home1">
                	...
                	<div class="table-responsive">
			            <table id="tabel_pemeriksaan" class="table table-bordered">
			                <thead>
			                    <tr class="biru">
                		...
                		<div class="card-box">
				            <div class="row">
			                    ...
			                    <div class="form-group">
			                        ...
			                        <div class="col-md-5">
			                            <input type="text" class="form-control" name="keterangan" value="" required="required">
			                        </div>
			                    </div>
			                    <div class="form-group">
        		...
        		<div class="card-box">
		            <div class="row">
		            	<div class="form-group">
	                        <label class="col-md-2 control-label">Kode</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" id="kode_ubah" value="" readonly>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Keterangan</label>
	                        <div class="col-md-5">
	                            <input type="text" class="form-control" name="keterangan_ubah" id="keterangan_ubah" value="" required="required">
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-2 control-label">Tarif</label>
