...
$(document).ready(function(){
    ...
    $('#batal').click(function(){
        window.location = "<?php echo base_url(); ?>finance/pembelian_oksigen_c";
    });
...
function get_kode_pb(){
    $.ajax({
        url : '<?php echo base_url(); ?>finance/pembelian_oksigen_c/get_kode_pb',
        type : "POST",
        dataType : "json",
...
function get_history(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>finance/pembelian_oksigen_c/data_pembelian',
        data : {
            bulan:bulan,
            tahun:tahun
        },
...
function ubah_history(id){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>finance/pembelian_oksigen_c/data_pembelian_id',
        data : {id:id},
        type : "POST",
        dataType : "json",
...
function get_barang(){
    ...
    ajax = $.ajax({
        url : '<?php echo base_url(); ?>finance/pembelian_oksigen_c/data_barang',
...
function klik_barang(id){
    $('#tutup_barang').click();
     ...
     $.ajax({
        url : '<?php echo base_url(); ?>finance/pembelian_oksigen_c/klik_barang',
        data : {id:id},
        type : "POST",
        dataType : "json",
        success : function(row){
...
<div class="row">
    	...
    	<div class="card-box">
            ...
            <div class="tab-content">
                <div id="history_pemebelian1" class="tab-pane fade in active" role="tabpanel">
                    <div class="row">
                        <form role="form" action="<?php echo base_url(); ?>finance/pembelian_oksigen_c/cetak" method="post" target="_blank">
                ...
                <div id="input_pembelian1" class="tab-pane fade" role="tabpanel">
                    <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>finance/pembelian_oksigen_c/simpan" method="post">
                        <div class="row">
                            <div class="form-group">
    ...
    <div class="col-lg-12" id="view_ubah">
        <div class="card-box">
            <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>finance/pembelian_oksigen_c/ubah" method="post">
...
<div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo base_url(); ?>finance/pembelian_oksigen_c/hapus" method="post">
