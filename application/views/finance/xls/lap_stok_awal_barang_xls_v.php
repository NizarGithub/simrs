...
<table align="center" class="grid">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="170" style="text-align: center;"><?php echo $value->ID; ?></td>
            ...
            <td style="width:120px; text-align: center;"><?php echo number_format($value->TOTAL,0,',','.'); ?></td>
            <td colspan="2" width="80" style="text-align: right;"><?php echo number_format($value->HARGA_BELI,0,',','.'); ?></td>
            <td width="250"><?php echo $value->KETERANGAN; ?></td>
        </tr>
        <?php
            }
        ?>
