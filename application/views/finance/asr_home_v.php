...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>picture/portal/Medical-23-512.ico">
    ...
    <body>
        ...
        <!-- Navigation Bar-->
        <header id="topnav">
            <div class="topbar-main" style="background-color:#56c1ab; height:60px;">
                <div class="container">

                    <!-- LOGO -->
                    <div class="topbar-left">
                        <a href="<?php echo base_url(); ?>asuransi/asuransi_c" class="logo" style="margin-top:4px;">
                    ...
                    <div class="menu-extras">
                        <?PHP 
                            ...
                            $user = $this->master_model_m->get_user_info($id_user);
                        ?>
                        <ul class="nav navbar-nav navbar-right pull-right" style="background-color:#00a78e; height:60px;">
                            <li>
                                <form role="search" class="navbar-left app-search pull-left hidden-xs" style="margin-right:0px; margin-top: 13px;">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li <?php if($master_menu == 'home'){ echo 'class="active"';}else{echo '';} ?> >
                                <a href="<?php echo base_url(); ?>asuransi/asuransi_c">
                                ...
                                <?PHP if($menu2->LINK == null || $menu2->LINK == ""){ ?>
                                    <li <?php if($master_menu == $menu2->MASTER){ echo 'class="has-submenu active"';}else{echo 'class="has-submenu"';} ?> >
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li <?php if($view == 'asuransi_'.$asr->ID){ echo 'class="active"';}else{echo '';} ?> >
                                                <a href="<?php echo base_url();?>asuransi/list_asuransi_c/index/<?=$asr->ID;?>">
                                                    <i class="fa fa-caret-right"></i> &nbsp; <?=$asr->NAMA_ASURANSI;?>
                                                </a>
                                            </li>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>portal">
                                    <i class="zmdi zmdi-view-dashboard"></i> <span> Portal Depan </span>
                                </a>
                            </li>
