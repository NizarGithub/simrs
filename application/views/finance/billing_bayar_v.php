...
<div class="wrapper" style="margin-top:0px;">	
	<div class="container">
    	...
    	<div class="row">
    		...
    		<input type="hidden" name="id_pasien_rj" value="<?php echo $id_pasien; ?>">
			<div class="col-lg-12">
				        ...
				        <div class="col-sm-12">
				        	<div class="table-responsives">
							    <table class="table table-bordered" style="font-size:15px; border: 2px solid #666;">
							        ...
							        <tbody>
							        	<?PHP 
							        	$dt_detail = $this->model->getDetailLayananRJ($id_pasien);
							        	$no = 0;
							        	$total = 0;							        	
							        	?> 
							        	<tr>
    	...
    	<form role="form" method="post" action="<?=base_url().$post_url;?>" onsubmit="return cek_bayar();">
		<div class="row">
		        ...
		        <div class="card-box" style="border-top: 3px solid #34bf49;">
		            <div class="row">
				        <div class="col-sm-12">
				        	<table>
				            	<tr>
				            		<td> <h4> <b> DIJAMIN </b> </h4> </td>
				            		<td style="text-align: left; width: 120px;"> &nbsp;&nbsp;&nbsp; : </td>
				            		<td align="right" style="font-size: 18px; width: 155px;"> <b> Rp. 0 </b> </td>
				            	</tr>
				            	<tr> <td>&nbsp;</td> </tr>
				            	<tr>
				            		<td> <h4> <b> TOTAL </b> </h4> </td>
				            		<td style="text-align: left; width: 120px;"> &nbsp;&nbsp;&nbsp; : </td>
				            		<td align="right" style="font-size: 18px; width: 155px;"> 
				            			<b> Rp. <?=number_format($total);?> </b>
				            			<input type="hidden" id="total_biaya" name="total_biaya" value="<?=$total;?>" />
				            		</td>
				            	</tr>
				            	<tr>
				            		<td colspan="3">
				            			<div class="input-group m-t-10">
                                            <span style="background:#FFF;" class="input-group-addon">Rp.</span>
                                            <input onkeyup="FormatCurrency(this); getKembali();" id="bayar" name="bayar" class="form-control" placeholder="BAYAR" type="text" style="text-align:right; font-size:18px;">
                                        </div>
				            		</td>
				            	</tr>
				            	<tr> <td>&nbsp;</td> </tr>
				            	<tr>
				            		<td> <h4> <b> KEMBALI </b> </h4> </td>
				            		<td style="text-align: left; width: 120px;"> &nbsp;&nbsp;&nbsp; : </td>
				            		<td align="right" style="font-size: 18px; width: 155px;"> 
				            			<b id="kembali_txt"> Rp. 0 </b> 
				            	...
				            	<tr>
				            		<td colspan="3">
				            			<button style="margin-top: 15px; font-size: 18px;" type="submit" class="btn btn-block btn-sm btn-success waves-effect waves-light">
				            				BAYAR SEKARANG
				            			</button>
				            			<input type="hidden" id="nomor_bill" name="nomor_bill" value="TR-<?=$nomor_bill->NOMOR;?>">
				            			<input type="hidden" id="id_pasien" name="id_pasien" value="<?=$id_pasien;?>">
				            			<input type="hidden" id="sts_layanan" name="sts_layanan" value="<?=$sts;?>">
				            			<input type="hidden" id="sistem_bayar" name="sistem_bayar" value="<?=$dt->SISTEM_BAYAR;?>">
				            		</td>
				            	</tr>
				            </table>
						</div>
...
<script type="text/javascript">
	...
	function getKembali(){
		...
		var kembali = bayar - total_biaya;

		if(bayar2 == "" || bayar2 == null){
			kembali = 0;
		}

		$('#kembali_txt').html('Rp. '+NumberToMoney(kembali).split('.00').join(''));
		$('#kembali').val(kembali);
	}
	...
	function cek_bayar(){
		...
		if(bayar == "" || bayar == null){
			alert('Mohon isikan nominal bayar terlebih dahulu !');
			a = false;
		} else {
			if(kembali < 0){
				a = false;
				alert('Nominal bayar tidak boleh kurang dari total biaya !');
			} else {
				a = true;
			}
		}
