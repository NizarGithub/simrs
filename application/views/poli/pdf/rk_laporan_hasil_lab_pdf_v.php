...
<table align="left">
    <tr>
        <td style="width:70px;">Dokter</td>
        <td>:</td>
        <td style="width:150px;"><?php echo $data1->NAMA_DOKTER; ?></td>
    ...
    <tr>
        ...
        <td>:</td>
        <td style="width:150px;"><?php echo $data1->HARI; ?>, <?php echo formatTanggal($data1->TANGGAL); ?></td>
        <td style="width:205px;">&nbsp;</td>
        <td style="width:85px;">Nama Pasien</td>
        <td>:</td>
        <td style="width:175px;"><?php echo $data1->NAMA_PASIEN; ?></td>
    </tr>
    <tr>
        <td style="width:70px;">Poli</td>
        <td>:</td>
        <td style="width:150px;"><?php echo $data1->NAMA_POLI; ?></td>
        <td style="width:205px;">&nbsp;</td>
