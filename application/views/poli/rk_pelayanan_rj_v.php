...
function data_rawat_jalan(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>poli/rk_pelayanan_rj_c/data_rawat_jalan',
		...
		success : function(result){
			...
			if(result == "" || result == null){
				...
				for(var i=0; i<result.length; i++){
					...
					var aksi =  '<a href="<?php echo base_url(); ?>poli/rk_pelayanan_rj_c/tindakan_rj/'+result[i].ID_RJ+'" class="on-default edit-row"><i class="fa fa-user-md"></i>&nbsp;Tindakan</a>';
...
function data_pasien_sudah(){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>poli/rk_pelayanan_rj_c/data_pasien_sudah',
		data : {keyword:keyword},
		type : "POST",
		dataType : "json",
		success : function(result){
			...
			if(result == "" || result == null){
				...
				for(var i=0; i<result.length; i++){
					...
					var aksi =  '<a href="<?php echo base_url(); ?>poli/rk_pelayanan_rj_c/tindakan_rj/'+result[i].ID_RJ+'" class="on-default edit-row"><i class="fa fa-user-md"></i>&nbsp;Ubah Tindakan</a>';
