...
function get_kode_satuan(){
	$.ajax({
        url : '<?php echo base_url(); ?>apotek/admum_setup_satuan_obat_c/kode_satuan_obat',
        type : "POST",
        dataType : "json",
...
function data_satuan(){
	...
	ajax = $.ajax({
        url : '<?php echo base_url(); ?>apotek/admum_setup_satuan_obat_c/get_data_satuan',
...
function ubah_satuan(id){
	...
	$.ajax({
		url : '<?php echo base_url(); ?>apotek/admum_setup_satuan_obat_c/data_satuan_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
...
<div class="col-lg-12">
    <div class="card-box card-tabs" id="view_data">
    	<ul class="nav nav-pills">
            <li class="active">
                <a href="#cardpills-1" data-toggle="tab" aria-expanded="true">Data Satuan Obat</a>
            </li>
            <li>
                <a href="#cardpills-2" data-toggle="tab" aria-expanded="false">Tambah Satuan Obat</a>
            </li>
        </ul>
