    ...
    .footer{
      ...
      <div style="clear: both;"></div>
        ...
        <table style="width: 100%;">
          <tr>
            <td style="text-align: left; width: 88%;">Nomor: <?php echo $row['KODE_RESEP']; ?></td>
      ...
      <div style="margin: 0 auto; max-width: 950px;">
        <table style="width: 100%;">
          <?php
            ...
            $this->db->select('*');
            $this->db->from('rk_ri_resep_detail');
            $this->db->join('admum_setup_nama_obat', 'admum_setup_nama_obat.ID=rk_ri_resep_detail.ID_OBAT');
