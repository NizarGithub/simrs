<?php
    ...
    .footer{
      ...
      <span style="margin-left: 960px; font-size: 14px;">(KWITANSI POLI)</span>
        ...
        <table style="width: 100%;">
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 2%;">:</td>
              <td style="text-transform: uppercase; width: 21%;">Tindakan Poli</td>
        ...
        <table style="width: 100%;">
          <?php
            ...
            $query_here = $this->db->query("SELECT
                              ...
                              FROM
                              rk_tindakan_rj AS RKT
                              LEFT JOIN rk_tindakan_rj_detail AS RKTD ON RKT.ID=RKTD.ID_TINDAKAN_RJ
                              LEFT JOIN admum_setup_tindakan AS TINDAKAN ON TINDAKAN.ID=RKTD.TINDAKAN
                              WHERE RKT.ID_PELAYANAN = '$id_pelayanan'
                              ");
            $result_here = $query_here->result_array();
            foreach ($result_here as $rh) {
           ?>
          <tr>
            <td>-</td>
      ...
      <div class="footer">
        <table style="width: 100%;">
          ...
          <tr>
            ...
            <td style="width: 3%;">:</td>
            <td colspan="2" style="text-transform: uppercase">Rp. <?php echo number_format($row['TOTAL']); ?> TUNAI</td>
          </tr>
