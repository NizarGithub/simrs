...
<div class="struk">
  ...
  <div style="clear: both;"></div>
    <table style="width: 100%; font-size: 11px;">
      <tr>
        <td style="text-align: left; width: 63%;">Apoteker : <?php echo $row['NAMA_PEGAWAI']; ?></td>
    ...
    <tr>
      ...
      <td>:</td>
      <td style="width: 33%;"><?php echo $row['TANGGAL']; ?></td>
    ...
    <tr>
      ...
      <td>:</td>
      <td style="width: 33%;"><?php echo $row['NAMA']; ?></td>
